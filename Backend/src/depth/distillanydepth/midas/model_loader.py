...
from geobench.midas.dpt_depth import DPTDepthModel
from geobench.midas.midas_net import MidasNet
from geobench.midas.midas_net_custom import MidasNet_small
